...
STAGES_TO_RUN = ['cifar100_granularity_v2', 'crossover_wide', 'epoch_matched_control']
TIME_BUDGET_HOURS_PER_STAGE = 4.0  # per shard/process; kernel session cap is ~9-12h total
