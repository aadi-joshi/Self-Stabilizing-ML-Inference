...
perturbations, Section~\ref{sec:diagnostic}), more than four times the
$24$-fold range spanned by 30 architectures with the schedule held fixed
(Section~\ref{sec:crossover}). Right: holding the schedule ratio
