...
def get_split_cifar100_tasks(
    ...
    train_data = datasets.CIFAR100(data_dir, train=True, download=True, transform=transform)
    test_data = datasets.CIFAR100(data_dir, train=False, download=True, transform=transform)
